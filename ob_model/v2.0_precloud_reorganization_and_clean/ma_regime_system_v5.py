...
OUTPUT_FILE = 'ma_regime_labeled_data_with_perfect_v57_test.csv'
SCORING_FILE = 'regime_scoring_metrics_v57_test.csv'
TIMEFRAME = '15min'
...
CORE_PARAMS = {
    ...
    'bull_weak_percentile': 0.60,
    'bull_strong_percentile': 0.80,
    'bear_weak_percentile': 0.40,
    'bear_strong_percentile': 0.20,
