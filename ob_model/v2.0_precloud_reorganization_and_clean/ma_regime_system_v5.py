...
OUTPUT_FILE = 'ma_regime_labeled_data_with_perfect_v62_test.csv'
SCORING_FILE = 'regime_scoring_metrics_v62_test.csv'
TIMEFRAME = '15min'
...
CORE_PARAMS = {
    ...
    'volatility_high_bear_percentile': 0.75,
